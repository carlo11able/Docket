class QuestionsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @question.update(question_params)
        format.html { redirect_to photo_question_path(question_params[:photo_id],@question), notice: 'Question was successfully updated.' }
  ...
  def destroy
    @question.destroy
    respond_to do |format|
      format.html { redirect_to photo_questions_path, notice: 'Question was successfully destroyed.' }
